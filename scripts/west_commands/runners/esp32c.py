...
'''Runner for flashing ESP32C devices with esptool/espidf.'''
...
class Esp32BinaryRunner(ZephyrBinaryRunner):
    ...
    def do_run(self, command, **kwargs):
        ...
        cmd_convert = [self.espidf, '--chip', 'esp32c', 'elf2image', self.elf]
        cmd_flash = [self.espidf, '--chip', 'esp32c', '--no-stub','--port', self.device,
        ...
        self.logger.info("Flashing ESP32C on {} ({}bps)".
