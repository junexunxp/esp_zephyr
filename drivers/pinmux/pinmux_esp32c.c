...
#define DT_DRV_COMPAT espressif_esp32c_pinmux
 ...
 */
#define PIN(id)   ((PERIPHS_IO_MUX_ ## id ## _U) - (REG_IO_MUX_BASE))
static const u8_t pin_mux_off[] = {
	...
	PIN(GPIO20),       PIN(GPIO21),   PIN(SPICS1),   PIN(SPIHD),
	...
	PIN(U0RXD),   PIN(GPIO45),    PIN(GPIO46), PIN(SPICLK_P),PIN(SPICLK_N)
};
#undef PIN
